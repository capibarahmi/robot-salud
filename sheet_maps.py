...
ALL_SHEETS = {
  ...
  "GENERALES": [
    "Actividad",
    "Consultas De Atención Integral Por El Equipo De Salud",
    "Total Consulta Atención Integral por Tipo de Médico",
    "Medicina Familiar",
    "Medicina General",
    "Medicina Interna",
    "Endocrino",
    ...
    "Enfermería",
    "Psicología",
    "Total de Emergencias Atención Integral por Tipo de Médico",
    "Emergencias Pediátricas",
    "Emergencias Adultos",
    "Total de Urgencias Atención Integral por Tipo de Médico",
    ...
    "Citodiagnóstico",
    "Autopsias",
    "Actividades de Nivel Terciario",
    "Aborto",
    "Partos"
  ]
}
...
SHEET_ALIASES = {
    ...
    "PRENATAL": "SSR",
    "OBSTETRICIA": "SSR",
    "GASTRO": "MORBILIDAD DE CONSULTA EXTERNA",
    "NEONATOLOGIA": "PNNA",
    "CIRUGIA PEDIATRICA": "PNNA",
    "PUERICULTURA": "PNNA",
    "DERMATOLOGIA": "MORBILIDAD DE CONSULTA EXTERNA",
    "NEFROLOGIA": "MORBILIDAD DE CONSULTA EXTERNA",
    "HEMATOLOGIA": "MORBILIDAD DE CONSULTA EXTERNA",
    "ONCOLOGIA": "MORBILIDAD DE CONSULTA EXTERNA",
    "ENFERMERIA": "GENERALES",
    "GENERALES (RESUMEN TOTAL)": "GENERALES",
    "PNNA (PROGRAMA NIÑO, NIÑA Y ADOLESCENTE)": "PNNA",
    "ADOLESCENTE (12 A 19 AÑOS - INTEGRAL)": "PNNA",
    "ADOLESCENTE": "PNNA",
    "ADOLESCENTES": "PNNA",
    "PADULTO 19 A 60 AÑOS": "PADULTO 19 A 60 AÑOS",
    "ADULTOS MAYOR (60 AÑOS Y MÁS)": "ADULTOS MAYOR",
    "SSR (OBSTETRICIA Y GINECOLOGÍA)": "SSR",
    "SALUD BUCAL (ODONTOLOGÍA)": "SALUD BUCAL",
    "DERMATOLOGIA SANITARIA": "DERMATOLOGÍA SANITARIA",
    "SALUD RENAL (NEFROLOGÍA)": "SALUD RENAL",
    "ENDOCRINO METABOLICO": "ENDOCRINO-METABOLICO",
    "ENDOCRINOLOGIA": "ENDOCRINO-METABOLICO"
}
...
def get_all_sheets_combined_prompt():
    ...
    for sheet_name, rows in ALL_SHEETS.items():
        consolidado += f"\n📍 HOJA: \"{sheet_name}\"\n"
        consolidado += "\n".join([f"  - {r}" for r in rows]) # Visión completa de todas las filas
        consolidado += "\n"
